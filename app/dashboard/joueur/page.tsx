...
export default function JoueurDashboard() {
  const [availableEvents, setAvailableEvents] = useState([
    {
      id: 1,
      name: "Tournoi de Tennis Individuel",
      type: "PLAYOFF",
      date: "15/12/2024",
      participants: "32/64",
      organizer: "Tennis Club Local",
      status: "Inscriptions ouvertes",
      sport: "Tennis",
    },
    {
      id: 2,
      name: "Championnat de Golf",
      type: "LEAGUE",
      date: "20/12/2024",
      participants: "24/40",
      organizer: "Golf Club Régional",
      status: "Inscriptions ouvertes",
      sport: "Golf",
    },
    {
      id: 3,
      name: "Compétition de Natation",
      type: "CUP",
      date: "25/12/2024",
      participants: "16/32",
      organizer: "Piscine Municipale",
      status: "Inscriptions ouvertes",
      sport: "Natation",
    },
  ]);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {availableEvents.map((event) => (
                ...
                >
                  ...
                  <div className="mb-3">
                    <span className="inline-block bg-cyan-100 text-cyan-800 text-xs px-2 py-1 rounded-full mb-2">
                      {event.sport}
                    </span>
                  </div>
